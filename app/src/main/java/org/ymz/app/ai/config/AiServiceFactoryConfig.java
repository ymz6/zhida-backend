...
public class AiServiceFactoryConfig {
     ...
     */
    @Bean
    CodeGenerateAiService codeGenerateAssistant(StreamingChatModel codeGenerateModel, RedisChatMemoryStore redisChatMemoryStore, AiToolRegistry aiToolRegistry) {
